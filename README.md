...
If you are connecting to nodes outside of your local network and do not want to use port forwaring, you will need to create a tunnel with Ngrok, make sure you install / create an account / authenticate. All the necessary steps are [here](https://dashboard.ngrok.com/signup)
